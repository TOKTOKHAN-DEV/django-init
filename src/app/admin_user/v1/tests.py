...
class AdminUserListAPITest(APITestCase):
    MODEL = AdminUser
    PATH = "/v1/admin_user/"
...
class AdminUserCreateAPITest(APITestCase):
    MODEL = AdminUser
    PATH = "/v1/admin_user/"
...
class AdminUserRetrieveAPITest(APITestCase):
    MODEL = AdminUser
    PATH = "/v1/admin_user/{id}/"
...
class AdminUserUpdateAPITest(APITestCase):
    MODEL = AdminUser
    PATH = "/v1/admin_user/{id}/"
...
class AdminUserDestroyAPITest(APITestCase):
    MODEL = AdminUser
    PATH = "/v1/admin_user/{id}/"
